 ...
 const [showPassword, setShowPassword] = React.useState(false);
  ...
  const handleSubmit = (e)=>{
     e.preventDefault();
      console.log("handle")
    axios
      .post("http://localhost:8080/persons/register", user)
      .then((res) => {
      ...
      <div className="bg-slate-100 h-[100vh] items-center flex justify-center">
        <form onSubmit={handleSubmit}>
          ...
          <div className='flex justify-center'>
           ...
           <Link to="/" className='hover:cursor-pointer text-blue-600 flex justify-center  mt-5'> Vous avez un compte ? Se connecter</Link>
        </form>
      </div>
    </div>
  )
